        ...
        <div className="row">
              ...
              <div className="col-md-9">
                  ...
                  <div className="m-1 w-75">
                    ...
                    <div className="mb-3">
                      <input type="text" value={price} placeholder="write a Price" className="form-control"
                    ...
                    showSearch className="form-select mb-3" onChange={(value) => {setShipping(value)}} value={shipping ? "yes" : "No"}>
